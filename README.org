...
#+begin_src bash
kafctl -brokers "localhost:9092" -list 
#+end_src
...
#+begin_src bash
kafctl -brokers "localhost:9092" -create dumy2
#+end_src>

With replicationFactor and paritions

#+begin_src bash
kafctl -brokers "locatlhost:9092" -brokers "localhost:9092" -create dumy4 -partitions 3 -replication 1
#+end_src>
